...
public class HSpace{
    ...
    public static void load() {
        ahkar = new Planet("ahkar", Planets.sun, 0.6f, 3) {{
            generator = new AhkarPlanetGenerator();
            meshLoader = () -> new HexMesh(this, 5);
            /*cloudMeshLoader = () -> new MultiMesh(
                new HexSkyMesh(this, 11, 0.15f, 0.13f, 5, new Color().set(Pal.darkishGray).mul(0.9f).a(0.75f), 2, 0.45f, 0.9f, 0.38f),
                new HexSkyMesh(this, 1, 0.6f, 0.16f, 5, Color.white.cpy().lerp(Pal.darkishGray, 0.55f).a(0.75f), 2, 0.45f, 1f, 0.41f)
            );*/
            alwaysUnlocked = true;
            landCloudColor = Color.valueOf("Pal.darkishGray");
            atmosphereColor = Color.valueOf("Pal.darkishGray");
            ...
            defaultCore = HBlocks.corePedestal;
            ...
            unlockedOnLand.add(HBlocks.corePedestal);
        }};
    }
}
