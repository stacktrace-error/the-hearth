...
public class HInput extends DesktopInput{
    ...
    public void tryDropPayload() {
        ...
        if (unit instanceof TractorPayloadUnit) {
            if(((TractorPayloadUnit)unit).beamHeld != null) {
                Call.requestDropPayload(Vars.player, Vars.player.x, Vars.player.y);
            } else ((TractorPayloadUnit)unit).moveOut();
    ...
    public void tryPickupPayload() {
        Unit unit = Vars.player.unit();
        if (unit instanceof TractorPayloadUnit) {
            TractorPayloadUnit pay = (TractorPayloadUnit)unit;
